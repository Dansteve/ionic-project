...
//        console.log(finds);
        $http.get(finds)
            .success(function (newItems) {
                ...
                $scope.address2 = $scope.newItems[1].long_name + ' ' + $scope.newItems[3].long_name + ' ' + $scope.newItems[5].long_name + ' ' + $scope.newItems[6].long_name
...
IonicApp.controller('SideCtrl', function ($scope, $state, $ionicPush, $stateParams, Childs, $localstorage, $ionicAuth, $http, $sce, $ionicLoading, $compile, $ionicPopup, $http, $cordovaGeolocation, $ionicLoading, $compile, Vendors, $ionicPopup, $http, $ionicPopup, $cordovaGeolocation, Parents) {
...
IonicApp.controller('AccountCtrl', function ($scope, $state, Parents, $localstorage, Vendors, $cordovaCamera,$ionicPopup, $cordovaFile, $cordovaFileTransfer, $cordovaDevice, $ionicPopup, $cordovaActionSheet, $ionicLoading) {
...
IonicApp.controller('LoginCtrl', function ($scope, $state, $ionicModal, $ionicPopup, Childs, $ionicSlideBoxDelegate,$ionicPopup, Parents, Days, $localstorage, $firebase, $ionicAuth) {
...
IonicApp.controller('MapsCtrl', function ($scope, $stateParams, Childs, $ionicModal, $ionicLoading, $compile, $ionicPopup, $http, $cordovaGeolocation, Parents, Drivers, $localstorage) {
