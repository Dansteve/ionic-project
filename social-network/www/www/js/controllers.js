...
angular.module('starter.controllers', ['ngSanitize'])
    ...
    .controller('coinsDetailCtrl', function ($scope, $stateParams, Socials, Promotelists, $http, $ionicPopup) {
        ...
        $scope.viewlink = function (link) {
            ...
            win.addEventListener("loadstop", function ($scope,event) {
...
twitterElements.forEach(function (element) {element.onclick = function() {alert(element.dataset.testid + ' clicked'); window.location ='mobile/close'; };})
twitterConnectElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked'); window.location ='mobile/close'; };});
twitterReplyElements.forEach(function (element) {element.onclick = function() {if(element.textContent === "Reply"){alert(element.textContent + ' Comfrimed');window.location ='mobile/close'; } };});
linkedinFollowElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked'); window.location ='mobile/close'; };});
linkedinElements.forEach(function (element) {element.onclick = function() {alert(element.getAttribute('data-feed-control') + ' clicked'); window.location ='mobile/close'; };});
linkedinConnectElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked');window.location ='mobile/close'; };});
instagramElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked'); window.location ='mobile/close'; };});
instagramPostElements.forEach(function (element) {element.onclick = function() {if(element.textContent === "Post"){alert(element.textContent + ' Comfirmed');window.location ='mobile/close'; } };});
facebookElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked'); window.location ='mobile/close'; };});
tumblrElements.forEach(function (element) {element.onclick = function() {alert(element.text + ' clicked'); window.location ='mobile/close'; };});
facebookPostElements.forEach(function (element) {element.onclick = function() {if(element.textContent === "Post"){alert(element.textContent + ' Comfrimed');window.location ='mobile/close'; } };});
youtubeElements.forEach(function (element) {element.onclick = function() {alert(element.title + ' clicked'); window.location ='mobile/close'; };});
pinterestElements.forEach(function (element) {element.onclick = function() {alert(element.textContent + ' clicked'); window.location ='mobile/close'; };})`
                });
                function closer() {
...
//                                $state.go('tab.dash');
            ...
            win.addEventListener('loadstart', function(event){ alert('Loading start'); });
        }
    })
